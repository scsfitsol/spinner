...
import fitsol_logo2 from "../SpinMain/fitsol_logo2.svg";
const CertificateModal = ({ visible, onClose, userData }) => {
  ...
  return (
    ...
    >
      <div
        ref={componentRef}
        className="m-5 mr-5 ml-5 border-4 border-green-600 mx-auto p-5 rounded-lg bg-white shadow-md mt-5 "
      >
        ...
        <div className="text-left mb-5 text-sm mx-[4.5%]">
          <p className="mb-3 ml-5 mt-0">
            Fitsol commits to retire the purchased carbon credits or
            certificates in the relevant public registry in line with the
            highest International carbon accounting and reporting standards.
            These credits are utilised to offset the estimated carbon footprint
            of the beneficiary for the year 2023-24
          </p>
          <hr className="border-t-4 border-D7E5BE w-full" />
          <center>
            <p className="text-sm ml-1">
              This certificate is issued by Fitsol Supply Chain Solutions
              Private Limited. For more information about our services and
              climate change mitigation projects, please visit{" "}
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-lg text-center">
        ...
        <p className="text-lg text-gray-700 mb-6">
          As a participant in our contest, you can claim your certificate
          recognizing your support for sustainable practices and environmental
          conservation. Please click on the link below to receive your
